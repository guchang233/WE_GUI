 ...
 * MaLiLib 风格的统一配置。
 *
 * <p>渲染相关参数直接交由 Litematica（通过 {@code LitematicaBridge}）维护，
 * WeGui 仅保留粘贴预览放置模式、状态栏、命令面板等自有配置。</p>
 */
public class Configs implements IConfigHandler {
    ...
    public static class PastePreview {
        ...
        /** 仅替换空气方块：粘贴时跳过目标位置非空气方块，避免覆盖已有建筑。 */
    ...
    public static class CommandPanel {
        ...
        public static final ConfigString FAVORITES = new ConfigString("commandPanelFavorites", "copy,paste,clearclipboard,flip,rotate,set,replace,undo,redo,desel").apply(COMMAND_PANEL_KEY);
