...
public interface FabricPermissionsProvider {
    ...
    boolean hasPermission(class_3222 player, String permission);
    ...
    class VanillaPermissionsProvider implements FabricPermissionsProvider {
        ...
        public boolean hasPermission(class_3222 player, String permission) {
            ...
            return configuration.cheatMode
                || player.method_51469().method_8503().method_3760().method_14569(player.method_72498())
                || (configuration.creativeEnable && player.field_13974.method_14257() == class_1934.field_9220);
        }
