...
public final class CommandWrapper {
    ...
    public static void register(CommandDispatcher<class_2168> dispatcher, org.enginehub.piston.Command command) {
        ...
        Command<class_2168> commandRunner = ctx -> {
        ...
        for (String alias : aliases.build()) {
            LiteralArgumentBuilder<class_2168> base = method_9247(alias).executes(commandRunner)
                    .then(method_9244("args", StringArgumentType.greedyString())
    ...
    private static CompletableFuture<Suggestions> suggest(CommandContext<class_2168> context,
