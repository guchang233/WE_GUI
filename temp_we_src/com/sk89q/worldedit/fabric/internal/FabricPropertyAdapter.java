...
class FabricPropertyAdapter<T extends Comparable<T>> implements Property<T> {
    ...
    private final net.minecraft.class_2769<T> property;
    private final List<T> values;

    FabricPropertyAdapter(net.minecraft.class_2769<T> property) {
        this.property = property;
        this.values = ImmutableList.copyOf(property.method_11898());
    }

    @Override
    public String name() {
        return property.method_11899();
    }
    ...
    public T getValueFor(String string) throws IllegalArgumentException {
        Optional<T> val = property.method_11900(string);
